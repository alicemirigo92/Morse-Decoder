# Mor<a name="readme-top">MORSE-DECODER</a>
...
**MORSE CODE DECODER** is an exercise to create methods for decoding morse code messages using Ruby.
...
```sh
  cd my-folder
  git clone https://github.com/alicemirigo92/Morse-Decoder.git
```
-
...
Feel free to check the [issues page](https://github.com/alicemirigo92/Morse-Decoder/issues).
